...
@implementation PersonRecordingVC
...
{
    static NSString *CellIdentifier = @"PersonRecordingCell";
    ...
    switch (indexPath.row) 
    {
        ...
        case 0:
            [cell.textLabel setText:@"Inserter"];
            break;
        case 1:
            [cell.textLabel setText:@"Observer"];
            break;
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [appDelegate.vc1 setPersonRecording:currCell.textLabel.text];
}
